...
class TestCalendar(unittest.TestCase):
    ...
    def test_Calendar_next_bizday(self):
        ...
        self.assertEqual(self.cal_ANBIMA.adjust_next('2013-01-01', iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.adjust_next('2013-01-02', iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.following('2013-01-02', iso=True), '2013-01-02')

    def test_Calendar_previous_bizday(self):
        '''previous_bizday calculations'''
        self.assertEqual(self.cal_ANBIMA.adjust_previous('2013-02-02', iso=True), '2013-02-01')
        self.assertEqual(self.cal_ANBIMA.preceding('2013-02-02', iso=True), '2013-02-01')
        self.assertEqual(self.cal_ANBIMA.adjust_previous('2013-02-01', iso=True), '2013-02-01')
        self.assertEqual(self.cal_ANBIMA.preceding('2013-02-01', iso=True), '2013-02-01')

    def test_Calendar_modified_following(self):
        '''modified_following calculations'''
        self.assertEqual(self.cal_ANBIMA.modified_following('2013-01-01', iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.modified_following('2016-01-31', iso=True), '2016-01-29')

    def test_Calendar_modified_preceding(self):
        '''modified_preceding calculations'''
        self.assertEqual(self.cal_ANBIMA.modified_preceding('2013-01-01', iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.modified_preceding('2016-01-31', iso=True), '2016-01-29')

    def test_Calendar_seq(self):
        '''sequence generator of bizdays'''
        dts = ('2013-01-02', '2013-01-03', '2013-01-04', '2013-01-07', '2013-01-08',
    ...
    def test_Calendar_offset(self):
        ...
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-02', 1, iso=True), '2013-01-03')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-02', 0, iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-02', -1, iso=True), '2012-12-31')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-02', 1, iso=True), '2012-01-03')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-02', 3, iso=True), '2012-01-05')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-02', 0, iso=True), '2012-01-02')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-02', -1, iso=True), '2011-12-30')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-02', -3, iso=True), '2011-12-28')
        # offset non working days
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-01', 2, iso=True), '2013-01-03')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-01', 1, iso=True), '2013-01-02')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-01', 0, iso=True), '2013-01-01')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-01', -1, iso=True), '2012-12-31')
        self.assertEqual(self.cal_ANBIMA.offset('2013-01-01', -2, iso=True), '2012-12-28')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-01', 1, iso=True), '2012-01-02')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-01', 0, iso=True), '2012-01-01')
        self.assertEqual(self.cal_ANBIMA.offset('2012-01-01', -1, iso=True), '2011-12-30')

    def test_Calendar_getdate_getnth_bizday(self):
        # first
        self.assertEqual(self.cal_ANBIMA.getdate('first bizday', 2002, iso=True), '2002-01-02')
        self.assertEqual(self.cal_ANBIMA.getdate('first day', 2002, 1, iso=True), '2002-01-01')
        self.assertEqual(self.cal_ANBIMA.getdate('first bizday', 2002, 1, iso=True), '2002-01-02')
        self.assertEqual(self.cal_ANBIMA.getdate('first wed', 2002, 2, iso=True), '2002-02-06')
        # last
        self.assertEqual(self.cal_ANBIMA.getdate('last day', 2002, 2, iso=True), '2002-02-28')
        self.assertEqual(self.cal_ANBIMA.getdate('last bizday', 2002, 2, iso=True), '2002-02-28')
        # nth
        self.assertEqual(self.cal_ANBIMA.getdate('second bizday', 2002, 2, iso=True), '2002-02-04')
        self.assertEqual(self.cal_ANBIMA.getdate('third tue', 2002, 2, iso=True), '2002-02-19')
        # closest
...
def test_isseq():
    ...
    assert isseq('wilson') == False
    assert isseq(1) == False
    assert isseq([]) == True
...
class TestDateIndex(unittest.TestCase):
    def test_DateIndex_start_workday_end_workday(self):
        ...
        cix = DateIndex([], startdate='2020-04-01', enddate='2020-04-07', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_nonworkday_end_workday(self):
        'it should instanciate the calendar starting on nonworkday and ending on workday'
        cix = DateIndex([], startdate='2020-03-29', enddate='2020-04-03', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_weekend_end_workday(self):
        'it should instanciate the calendar starting on weekend and ending on workday'
        cix = DateIndex([], startdate='2020-03-28', enddate='2020-04-03', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_workday_end_nonworkday(self):
        'it should instanciate the calendar starting on workday and ending on nonworkday'
        cix = DateIndex([], startdate='2020-04-01', enddate='2020-04-04', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_workday_end_weekend(self):
        'it should instanciate the calendar starting on workday and ending on weekend'
        cix = DateIndex([], startdate='2020-04-01', enddate='2020-04-05', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_nonworkday_end_nonworkday(self):
        'it should instanciate the calendar starting on nonworkday and ending on nonworkday'
        cix = DateIndex([], startdate='2020-03-29', enddate='2020-04-04', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])

    def test_DateIndex_start_weekend_end_weekend(self):
        'it should instanciate the calendar starting on nonworkday and ending on nonworkday'
        cix = DateIndex([], startdate='2020-03-28', enddate='2020-04-05', weekdays=(5, 6))
        assert all(cix._index[dt][0] == cix._index[dt][3] for dt in cix._index if not cix._index[dt][2])
    ...
    def test_DateIndex_getdate(self):
        ...
        self.assertEqual(di.getdate('first bizday before last day', 2002, 1).isoformat(), '2002-01-30')
        self.assertEqual(di.getdate('second bizday before last day', 2002, 1).isoformat(), '2002-01-29')
